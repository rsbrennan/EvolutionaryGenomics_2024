...
R Markdown is plain text. The files end in `.Rmd`, but otherwise are just text files. Below is an example where we have three main parts. 
...
For your own analyses, you would put your own r code within the code block. 

## Code block details

There are many choices within code blocks. 
...
Change the language of your code block and re-knit. What happens?
...
Play around with the options you've just learned. 

- Add different headers to your document. 
- Add text in between your headers. 
- Add a list of a few lines to your document.
- Can you make your list numbered instead?
...
Find a list of the common options [here](https://www.markdownguide.org/cheat-sheet/) or ask chat GPT for help doing what you want to do.
