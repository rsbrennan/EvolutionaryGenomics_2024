...
Marker lists written to variants_pruned.prune.in and variants_pruned.prune.out
...
--make-bed to variants_NoLD.bed + variants_NoLD.bim + variants_NoLD.fam ...
done.
...
```
--pca: Results saved to variants_NoLD_PCA.eigenval and
variants_NoLD_PCA.eigenvec .
